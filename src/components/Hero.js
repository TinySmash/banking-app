  ...
  return (
    <div className="">
      <section className='Hero w-full h-screen block md:flex'>
          <img src="money.png" className="relative flex w-4/5 center-h mt-16 sm:w-2/3 sm:left-0 sm:translate-x-0 sm:ml-4 md:w-6/12 md:mt-24 md:mr-16 lg:w-5/12"></img>
          <div className="titles static w-full p-10 md:w-5/12 md:mt-56 ">
            ...
            <h2 className="subtitle text-2xl text-gray-800 mt-5">Most popular trading & banking platform in your hands</h2>
          </div>
      </section>
